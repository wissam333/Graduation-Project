...
const getProduct = async (req, res) => {
  try {
    ...
    // Create response object with both IDs and populated objects
    const response = {
      ...oneProduct.toObject(),
      restaurant: oneProduct.restaurantId,
...
const getProducts = async (req, res) => {
  try {
    ...
    // Transform products to include both IDs and populated objects
