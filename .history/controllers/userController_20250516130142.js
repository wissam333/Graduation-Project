...
const updateUser = async (req, res) => {
  try {
    ...
    // Handle restaurant assignment for managers
    if (updates.managedRestaurants) {
      ...
      // Remove user from old restaurant's managers
      if (oldRestaurantId) {
    ...
    // If changing role from manager to something else, clean up restaurant assignments
    if (updates.role && updates.role !== "2" && userToUpdate.role === "2") {
